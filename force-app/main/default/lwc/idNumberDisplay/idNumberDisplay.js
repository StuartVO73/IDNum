...
export default class IDNumberDisplay extends LightningElement {
    ...
    */
    ...
    handleClickComponents() {
        ...
        console.log("UpdateSF Components");
        this.updateSF();
    };
    ...
    handleClickHolidaysOnBirthday() {
        ...
        if (this.componentName) this.sendMessage();
        console.log("UpdateSF Holiday 2");
        this.updateSF();
    }
    ...
    async updateSF() {
        ...
        try {
            ...
            console.log("UpdateSF Success");
            this.error = undefined;
        } catch (error) {
            this.error = error;
            console.log("UpdateSF Error: " + objToString(this.error));
